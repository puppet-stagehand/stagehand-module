# -*- encoding: utf-8 -*-
# stub: orchestrator_client 0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<faraday>.freeze, [">= 1.4", "< 3.0"])
  s.add_runtime_dependency(%q<faraday-net_http_persistent>.freeze, [">= 1.0", "< 3.0"])
end
