# -*- encoding: utf-8 -*-
# stub: parallel_tests 5.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/grosser/parallel_tests/issues", "changelog_uri" => "https://github.com/grosser/parallel_tests/blob/v5.7.0/CHANGELOG.md", "documentation_uri" => "https://github.com/grosser/parallel_tests/blob/v5.7.0/Readme.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/grosser/parallel_tests/tree/v5.7.0", "wiki_uri" => "https://github.com/grosser/parallel_tests/wiki" } if s.respond_to? :metadata=
